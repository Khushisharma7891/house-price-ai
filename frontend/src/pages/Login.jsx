  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-80 h-80 bg-amber-50 rounded-full blur-3xl opacity-60"></div>
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-slate-100 rounded-full blur-3xl opacity-60"></div>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
          ...
          <div className="space-y-5">
            ...
            <button
              ...
              disabled={loading}
              className="w-full btn-primary py-3.5 rounded-xl text-sm disabled:opacity-50">
